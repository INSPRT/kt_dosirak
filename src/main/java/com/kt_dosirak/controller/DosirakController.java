...
public class DosirakController {
    ...
    public String itemlist(Integer page, Integer pageSize, String id, Model m){
        ...
        try {
            ...
            int totalCnt = productService.dosirakCount();
            ...
            List<ProductDto> dosirakList = productService.readDosirakPage(map);
            m.addAttribute("ph", pageHandler);
            m.addAttribute("dosirakList", dosirakList);
        } catch (Exception e) {
...
//        return "kt_product_detail";
        return "redirect:/dosirak/detail?product_id="+productDto.getProduct_id();
    }
    ...
    public String remove(String product_id) throws Exception{
        ...
        return "redirect:/dosirak/itemlist";
    }
