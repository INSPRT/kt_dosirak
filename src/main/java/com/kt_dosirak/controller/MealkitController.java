...
public class MealkitController {
    ...
    public String itemlist(Integer page, Integer pageSize, String id, Model m){
        ...
        try {
            ...
            int totalCnt = productService.mealkitCount();
            ...
            List<ProductDto> mealkitList = productService.readMealkitPage(map);
            m.addAttribute("ph", pageHandler);
            m.addAttribute("mealkitList", mealkitList);
        } catch (Exception e) {
...
//        return "kt_product_detail";
        return "redirect:/mealkit/detail?product_id="+productDto.getProduct_id();
    }
    ...
    public String remove(String product_id) throws Exception{
        ...
        return "redirect:/mealkit/itemlist";
    }
