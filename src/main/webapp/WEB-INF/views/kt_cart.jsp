    ...
    <div class="wrap">
           ...
           <div class="wrapAuto">
                ...
                <div class="cart_wrap">
                    ...
                    <div class="cart_header">장바구니</div>
                    ...
                    <div class="cart_announce">해당 식단을 유지할 경우 주당 <span>'n'kg</span>의 다이어트 효과가 있어요</div>
                        <form action="<c:url value="/order"/>" method="get">
                            <div class="cart_btn_wrap">
                                <input type="button" id="cart_empty" class="cart_return_btn" value="비우기">
                                <input type="submit" class="cart_pay_btn" value="구매하기">
                            </div>
                        </form>
                    </div>
                </div>
